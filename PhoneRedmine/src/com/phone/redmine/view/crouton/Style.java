...
public class Style {
  ...
  public static final int holoRedLight = 0xfffc6e51;
  public static final int holoGreenLight = 0xff8cc152;
  public static final int holoYelloLight = 0xfff0bd3e;
  ...
  static {
	 ERROR = new Builder()
      ...
      .build();
    ALERT = new Builder()
      .setBackgroundColorValue(holoYelloLight)
      .build();
    INFO = new Builder()
  ...
  private Style(final Builder builder) {
    ...
    this.paddingInDP = builder.paddingInDP;
  ...
  public static class Builder {
    ...
    public Builder(final Style baseStyle) {
      ...
      paddingInDP = baseStyle.paddingInDP;
    ...
    /** The padding for the crouton view's content in dp. */
    public Builder setPaddingInDP(int padding) {
      this.paddingInDP = padding;
      return this;
    }
