...
import com.phone.redmine.view.zrclistview.ZrcListView.OnScrollListener;
import com.phone.redmine.view.zrclistview.ZrcListView.OnScrollStateListener;
            ...
            public void run() {
                ...
                if (mFirstPosition == 0) {
                    ...
                    mFlingRunnable.startScroll(mFirstTop - newTop,
                            (int) (Math.abs(newTop - mFirstTop) / mDensity) + 0, true);
                    mTouchMode = TOUCH_MODE_RESCROLL;
                }else
                {
                	 isRefreshing = true;
                ...
                public void run() {
                    if (mFlingRunnable != null && mTouchMode != TOUCH_MODE_SCROLL) {
                        ...
                        if (!hasScroll) {
                            ...
                            postDelayed(mResetRunnable, 290);
                        }
                    } else {
                        postDelayed(mResetRunnable, 290);
                    }
