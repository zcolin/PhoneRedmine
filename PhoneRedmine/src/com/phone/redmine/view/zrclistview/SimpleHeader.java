...
public class SimpleHeader implements Headable {
    ...
    public SimpleHeader(Context context) {
        ...
        int fontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 18, context.getResources()
                .getDisplayMetrics());
...
//                }
                ...
                String text = mMsg != null ? mMsg : mState == STATE_SUCCESS ? "刷新成功" : "刷新失败";
                float y;
                if (offset < height) {
                    y = offset - height / 2;
                } else {
